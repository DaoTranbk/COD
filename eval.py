...
for dataset in test_datasets:
    ...
    def my_collate(batch):
        ...
        return [data, target]
    data_loader = data.DataLoader(dataset=loader, batch_size=16, shuffle=False, num_workers=8, pin_memory=True, drop_last=False, collate_fn=my_collate)############num_workers=8
